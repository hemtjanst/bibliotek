...
type HassConnInfo struct {
	Type string
	ID   string
}

func (c HassConnInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal([]string{c.Type, c.ID})
}

func (c *HassConnInfo) UnmarshalJSON(b []byte) error {
	var d []string
...
type HassDevInfo struct {
	ConfigurationUrl string         `json:"configuration_url,omitempty"`
	Connections      []HassConnInfo `json:"connections,omitempty"`
...
type HassDev struct {
	...
	Availability                   []HassAvailability `json:"avty,omitempty"`
	...
	Device                         *HassDevInfo       `json:"dev,omitempty"`
